...
function Signup({ onNavigate }) {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      if (data.success) {
        setBackendOtp(data.otp); // For testing only
  ...
  function validate() {
    ...
    if (!form.gradYear) err.gradYear = "Expected graduation year is required";
    else if (Number(form.gradYear) < currentYear || Number(form.gradYear) > currentYear + 10)
    ...
    if (!otp.trim()) err.otp = "OTP is required";
      ...
      err.otp = "Invalid OTP. Please verify your OTP";
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: "30px" }}>
          ...
          <div style={{
            ...
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              style={{ height: "30px", width: "30px", color: "#2196F3" }}
            >
          ...
          <h2 style={{ color: "#333", margin: "0 0 5px 0", fontSize: "24px" }}>Student Registration</h2>
          <p style={{ color: "#666", margin: 0 }}>Create your student account to access campus resources</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ 
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            <label style={{ marginBottom: "5px", color: "#555", fontSize: "14px" }}>Expected Graduation Year</label>
            <input
              name="gradYear"
              value={form.gradYear}
              onChange={handleChange}
          ...
          <div style={{ gridColumn: "1 / -1", display: "flex", flexDirection: "column" }}>
            ...
            <div style={{ display: "flex" }}>
              ...
              <button
                ...
                style={{
                  padding: "12px",
                  backgroundColor: isSendingOtp ? "#ccc" : "#2196F3",
                  color: "white",
                  border: "none",
          ...
          {showOtpField && (
            <div style={{ gridColumn: "1 / -1", display: "flex", flexDirection: "column" }}>
              <label style={{ marginBottom: "5px", color: "#555", fontSize: "14px" }}>OTP Verification</label>
              <div style={{ display: "flex" }}>
                <input
                  type="text"
              ...
              {errors.otp && <span style={{ color: "#e53e3e", fontSize: "14px", marginTop: "5px" }}>{errors.otp}</span>}
            </div>
          )}
